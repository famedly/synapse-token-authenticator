...
from synapse_token_authenticator.utils import OpenIDProviderMetadata, basic_auth
...
class TokenAuthenticator:
    ...
    async def check_oidc_auth(
        ...
        oidp_config = await OpenIDProviderMetadata.get_configuration(
            oidc.issuer, self.api.http_client
        )
        oidc_metadata = OpenIDProviderMetadata(oidc.issuer, oidp_config)
